...
het.bootstraps <- data.frame(pop=factor(), pop_hets=numeric(), lineage=factor(), 
                             env.var=factor(), env.group=factor(), n.bootstrap=numeric())


### for 25-95% sampling bootstrap
for (i in 1:n.bootstrap) {
  
  frac <- runif(n=1, min=0.25, max=0.95)
  dat_sub <- dat %>% group_by(Cross) %>% sample_frac(frac)
  
  ### lifetime heterosis ###
  ### APPALACHIAN ELEVATION ###
  
  #ALBG
  b1 <- mean(dat_sub[dat_sub$Cross == "ALBGxGA1",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "TN34xALBG",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "ALBG",]$lifetime), mean(dat_sub[dat_sub$Cross == "GA1",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "ALBG",]$lifetime), mean(dat_sub[dat_sub$Cross == "TN34",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  ...
  #GA1
  b1 <- mean(dat_sub[dat_sub$Cross == "ALBGxGA1",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "GA1xTN34",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "ALBG",]$lifetime), mean(dat_sub[dat_sub$Cross == "GA1",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "GA1",]$lifetime), mean(dat_sub[dat_sub$Cross == "TN34",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  GA1_het <- mean(c(h1,h2))
  
  #TN34
  b1 <- mean(dat_sub[dat_sub$Cross == "TN34xALBG",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "GA1xTN34",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "ALBG",]$lifetime), mean(dat_sub[dat_sub$Cross == "TN34",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "GA1",]$lifetime), mean(dat_sub[dat_sub$Cross == "TN34",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  ...
  #GA2
  b1 <- mean(dat_sub[dat_sub$Cross == "GA2xNC130",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "NC16xGA2",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "GA2",]$lifetime), mean(dat_sub[dat_sub$Cross == "NC130",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "GA2",]$lifetime), mean(dat_sub[dat_sub$Cross == "NC16",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  ...
  #NC130
  b1 <- mean(dat_sub[dat_sub$Cross == "GA2xNC130",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "NC130xNC16",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "GA2",]$lifetime), mean(dat_sub[dat_sub$Cross == "NC130",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "NC130",]$lifetime), mean(dat_sub[dat_sub$Cross == "NC16",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  NC130_het <- mean(c(h1,h2))
  
  #NC16
  b1 <- mean(dat_sub[dat_sub$Cross == "NC16xGA2",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "NC130xNC16",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "GA2",]$lifetime), mean(dat_sub[dat_sub$Cross == "NC16",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "NC130",]$lifetime), mean(dat_sub[dat_sub$Cross == "NC16",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  ...
  #EGG
  b1 <- mean(dat_sub[dat_sub$Cross == "EGGxTN92",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "PA104xEGG",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "EGG",]$lifetime), mean(dat_sub[dat_sub$Cross == "TN92",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "EGG",]$lifetime), mean(dat_sub[dat_sub$Cross == "PA104",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  ...
  #TN92
  b1 <- mean(dat_sub[dat_sub$Cross == "EGGxTN92",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "TN92xPA104",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "EGG",]$lifetime), mean(dat_sub[dat_sub$Cross == "TN92",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "TN92",]$lifetime), mean(dat_sub[dat_sub$Cross == "PA104",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  TN92_het <- mean(c(h1,h2))
  
  #PA104
  b1 <- mean(dat_sub[dat_sub$Cross == "PA104xEGG",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "TN92xPA104",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "EGG",]$lifetime), mean(dat_sub[dat_sub$Cross == "PA104",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "TN92",]$lifetime), mean(dat_sub[dat_sub$Cross == "PA104",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  ...
  #NC91
  b1 <- mean(dat_sub[dat_sub$Cross == "NC91xSK",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "VA73xNC91",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "NC91",]$lifetime), mean(dat_sub[dat_sub$Cross == "SK",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "NC91",]$lifetime), mean(dat_sub[dat_sub$Cross == "VA73",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  ...
  #SK
  b1 <- mean(dat_sub[dat_sub$Cross == "NC91xSK",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "SKxVA73",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "NC91",]$lifetime), mean(dat_sub[dat_sub$Cross == "SK",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "SK",]$lifetime), mean(dat_sub[dat_sub$Cross == "VA73",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  SK_het <- mean(c(h1,h2))
  
  #VA73
  b1 <- mean(dat_sub[dat_sub$Cross == "VA73xNC91",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "SKxVA73",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "NC91",]$lifetime), mean(dat_sub[dat_sub$Cross == "VA73",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "SK",]$lifetime), mean(dat_sub[dat_sub$Cross == "VA73",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  ...
  #IJ
  b1 <- mean(dat_sub[dat_sub$Cross == "IJxSH",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "HPxIJ",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "IJ",]$lifetime), mean(dat_sub[dat_sub$Cross == "SH",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "IJ",]$lifetime), mean(dat_sub[dat_sub$Cross == "HP",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  IJ_het <- mean(c(h1,h2))
  ...
  #SH
  b1 <- mean(dat_sub[dat_sub$Cross == "IJxSH",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "SHxHP",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "IJ",]$lifetime), mean(dat_sub[dat_sub$Cross == "SH",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "SH",]$lifetime), mean(dat_sub[dat_sub$Cross == "HP",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  SH_het <- mean(c(h1,h2))
  
  #HP
  b1 <- mean(dat_sub[dat_sub$Cross == "HPxIJ",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "SHxHP",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "IJ",]$lifetime), mean(dat_sub[dat_sub$Cross == "HP",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "SH",]$lifetime), mean(dat_sub[dat_sub$Cross == "HP",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  HP_het <- mean(c(h1,h2))
  ...
  #FC
  b1 <- mean(dat_sub[dat_sub$Cross == "FCxQH",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "HBxFC",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "FC",]$lifetime), mean(dat_sub[dat_sub$Cross == "QH",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "FC",]$lifetime), mean(dat_sub[dat_sub$Cross == "HB",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  FC_het <- mean(c(h1,h2))
  ...
  #QH
  b1 <- mean(dat_sub[dat_sub$Cross == "FCxQH",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "QHxHB",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "FC",]$lifetime), mean(dat_sub[dat_sub$Cross == "QH",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "QH",]$lifetime), mean(dat_sub[dat_sub$Cross == "HB",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  QH_het <- mean(c(h1,h2))
  
  #HB
  b1 <- mean(dat_sub[dat_sub$Cross == "HBxFC",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "QHxHB",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "FC",]$lifetime), mean(dat_sub[dat_sub$Cross == "HB",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "QH",]$lifetime), mean(dat_sub[dat_sub$Cross == "HB",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  HB_het <- mean(c(h1,h2))
  ...
  #FT
  b1 <- mean(dat_sub[dat_sub$Cross == "FTxMDP",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "VxFT",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "FT",]$lifetime), mean(dat_sub[dat_sub$Cross == "MDP",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "FT",]$lifetime), mean(dat_sub[dat_sub$Cross == "V",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  FT_het <- mean(c(h1,h2))
  ...
  #MDP
  b1 <- mean(dat_sub[dat_sub$Cross == "FTxMDP",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "MDPxV",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "FT",]$lifetime), mean(dat_sub[dat_sub$Cross == "MDP",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "MDP",]$lifetime), mean(dat_sub[dat_sub$Cross == "V",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  MDP_het <- mean(c(h1,h2))
  
  #V
  b1 <- mean(dat_sub[dat_sub$Cross == "VxFT",]$lifetime)
  b2 <- mean(dat_sub[dat_sub$Cross == "MDPxV",]$lifetime)
  m1 <- mean(c(mean(dat_sub[dat_sub$Cross == "FT",]$lifetime), mean(dat_sub[dat_sub$Cross == "V",]$lifetime)))
  m2 <- mean(c(mean(dat_sub[dat_sub$Cross == "MDP",]$lifetime), mean(dat_sub[dat_sub$Cross == "V",]$lifetime)))
  h1 <- (b1 - m1)/m1
  h2 <- (b2 - m2)/m2
  V_het <- mean(c(h1,h2))
  
  ### dat_subA FRAME OF HETEROSIS ###
  ...
  het.df$n.bootstrap <- i
  
  het.bootstraps <- rbind(het.bootstraps, het.df)
  
}


jpeg("plots/all_pops_bootstraps.jpeg", units="in", height=10, width=30, res=500)
ggplot(data=het.bootstraps)+
  geom_hline(yintercept = 0, linetype=1, color="black")+
  geom_density(aes(x=pop_hets, color=lineage))+
...
het.bootstrap.dat <- het.bootstraps %>% 
  group_by(pop, lineage, env.var, env.group) %>% 
  reframe(mean = mean(pop_hets), median=mean(pop_hets),
          se = sd(pop_hets)/sqrt(n()), ci95 = 1.96*(sd(pop_hets)/sqrt(n())))

het.bootstrap.dat$upper.ci <- het.bootstrap.dat$mean+het.bootstrap.dat$ci95
het.bootstrap.dat$lower.ci <- het.bootstrap.dat$mean-het.bootstrap.dat$ci95
het.bootstrap.dat

# write.csv(het.bootstraps, "data/heterosis/heterosis_lifetime_bootstrap.csv")
...
for (i in 1:n.bootstrap) {
  ...
  dat_sub <- dat %>% group_by(Cross) %>% sample_frac(size=1, replace=T)
...
jpeg("plots/all_pops_bootstraps_samplewithreplacement.jpeg", units="in", height=10, width=30, res=500)
ggplot(data=het.bootstraps)+
  geom_hline(yintercept = 0, linetype=1, color="black")+
  geom_density(aes(x=pop_hets, color=lineage))+
  scale_color_manual(values=c("forestgreen", "orchid4"))+
...
het.bootstrap.dat <- het.bootstraps %>% 
  group_by(pop, lineage, env.var, env.group) %>% 
  reframe(mean = mean(pop_hets), median=mean(pop_hets),
          se = sd(pop_hets)/sqrt(n()), ci95 = 3*(sd(pop_hets)/sqrt(n())))

het.bootstrap.dat$upper.ci <- het.bootstrap.dat$mean+het.bootstrap.dat$ci95
het.bootstrap.dat$lower.ci <- het.bootstrap.dat$mean-het.bootstrap.dat$ci95
het.bootstrap.dat

write.csv(het.bootstraps, "data/heterosis/heterosis_lifetime_bootstrap_samplewithreplacement.csv")
